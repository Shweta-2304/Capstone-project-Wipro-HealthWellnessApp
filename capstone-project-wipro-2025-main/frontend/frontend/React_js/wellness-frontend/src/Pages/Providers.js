  ...
  return (
    ...
    >
      <div className="container" style={{ maxWidth: "1000px" }}>
        {/* Hero Header */}
        <div className="d-flex align-items-center justify-content-center mb-4 bg-primary text-white p-4 rounded shadow-lg">
          <img
          ...
          <Card.Body>
            ...
            <Form onSubmit={handleSubmit} className="row g-3">
              ...
              <div className="d-grid">
                <Button variant={editId ? "info" : "primary"} type="submit">
        ...
        <div className="text-center mb-3">
          <Button
            variant={showProviders ? "outline-secondary" : "outline-primary"}
