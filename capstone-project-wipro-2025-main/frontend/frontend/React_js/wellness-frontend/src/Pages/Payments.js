...
import { Modal, Button, Form, Row, Col, Card, Badge, Dropdown, ButtonGroup } from "react-bootstrap";
    ...
    <div className="container py-4">
      ...
      <Card className="mb-4 shadow-lg border-0" style={{ borderRadius: "16px" }}>
        <Card.Header
          ...
          style={{
            background: "linear-gradient(135deg, #6C63FF, #4B46C6)",
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered size="md">
        <Modal.Header closeButton style={{ background: "#20c997", color: "white" }}>
